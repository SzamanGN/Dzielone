...
import static dodatki.Stale.Kierunek.GORA;
import static dodatki.Stale.Kierunek.LEWO;
import static dodatki.Stale.Kierunek.PRAWO;
import static dodatki.Stale.StaleGracza.BIEGNIE;
import static dodatki.Stale.StaleGracza.PobierzDuszkaWielkosc;
import static dodatki.Stale.StaleGracza.STOI;
...
public class Gracz extends Duszek {
	...
	private float graczPredkosc = 1.0f;
	private int[][] pozData;
