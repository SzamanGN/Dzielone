...
import app.okna.renderery.RendererKurnik;
import app.opupy.PopupKogutow;
import app.opupy.PoupKury;
...
public class OknoFarmy extends JFrame {
	...
	public MenagerList listy = new MenagerList();
	...
	private void pokazDrub(int indeks) {
		int rodzaj = kurnik.get(indeks).getRodzaj();
		System.out.println("Wybrano rodzaj: " + rodzaj);
		switch(rodzaj) {
			case 0: // popup kogutow
				new PopupKogutow(this);
				break;
			case 1: // popup kury
				new PoupKury(this);
				break;
